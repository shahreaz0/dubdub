import{R as e,L as a,M as t,N as r,g as l,u as c,C as s,a as m,b as n,c as i,I as d,A as o,D as E,S as p,d as N,e as g,f as u,h,B as v,i as x}from"./vendor.07ce90db.js";!function(){const e=document.createElement("link").relList;if(!(e&&e.supports&&e.supports("modulepreload"))){for(const e of document.querySelectorAll('link[rel="modulepreload"]'))a(e);new MutationObserver((e=>{for(const t of e)if("childList"===t.type)for(const e of t.addedNodes)"LINK"===e.tagName&&"modulepreload"===e.rel&&a(e)})).observe(document,{childList:!0,subtree:!0})}function a(e){if(e.ep)return;e.ep=!0;const a=function(e){const a={};return e.integrity&&(a.integrity=e.integrity),e.referrerpolicy&&(a.referrerPolicy=e.referrerpolicy),"use-credentials"===e.crossorigin?a.credentials="include":"anonymous"===e.crossorigin?a.credentials="omit":a.credentials="same-origin",a}(e);fetch(e.href,a)}}();const y=a=>e.createElement("div",{className:"Home"},e.createElement("div",{className:"home-text"},e.createElement("p",null,"Rick"),e.createElement("p",{className:"and"},"And"),e.createElement("p",null,"Morty")),e.createElement("div",{className:"home-img"},e.createElement("img",{src:"https://res.cloudinary.com/dlfozpwa2/image/upload/v1630018543/WallpaperDog-16992087_1_yurmri.png",alt:"Home image",width:"300px"})));const{Header:f}=a,k=l=>e.createElement(a,{className:"layout"},e.createElement(f,{style:{position:"fixed",zIndex:1,width:"100%"}},e.createElement(t,{mode:"horizontal",defaultSelectedKeys:["home"]},e.createElement(t.Item,{key:"home"},e.createElement(r,{to:"/"},"Home")),e.createElement(t.Item,{key:"characters"},e.createElement(r,{to:"/characters"},"Characters")),e.createElement(t.Item,{key:"episodes"},e.createElement(r,{to:"/episodes"},"Episodes")),e.createElement(t.Item,{key:"locations"},e.createElement(r,{to:"/locations"},"Location"))))),{Meta:b}=n,A=l`
	{
		characters {
			results {
				name
...
`,w=a=>{const{loading:t,error:r,data:l}=c(A);if(t)return e.createElement("div",{className:"loader"},e.createElement("div",{className:"lds-ripple"},e.createElement("div",null),e.createElement("div",null)));if(r)return e.createElement("div",{className:"loader"},e.createElement("p",{className:"error"},"Error happen. Try Again."));const{results:d}=l.characters,o=d.map(((a,r)=>e.createElement(s,{xs:24,sm:8,lg:6,key:r},e.createElement(m,{to:`/characters/${a.id}`},e.createElement(n,{loading:t,hoverable:!0,cover:e.createElement("img",{alt:a.name,src:a.image})},e.createElement(b,{title:a.name}))))));return e.createElement("div",{className:"m-lg"},e.createElement(i,{gutter:[24,16]},e.createElement(s,{xs:24,md:6,lg:6},e.createElement("div",{className:"side-text"},"Characters")),e.createElement(s,{xs:24,md:18,lg:18},e.createElement(i,{gutter:[24,16],className:"cards"},o))))};const I=a=>{const{id:t}=a.match.params,r=l`
		{
			character(id: "${t}") {
				name
				status
...
`,$=a=>{const{loading:t,error:r,data:l}=c(T);if(t)return e.createElement("div",{className:"loader"},e.createElement("div",{className:"lds-ripple"},e.createElement("div",null),e.createElement("div",null)));if(r)return e.createElement("div",{className:"loader"},e.createElement("p",{className:"error"},"Error happen. Try Again."));const{results:d}=l.episodes,o=d.map(((a,t)=>e.createElement(s,{xs:24,sm:8,lg:6,key:t},e.createElement(m,{to:`/episodes/${a.id}`},e.createElement(n,{hoverable:!0},e.createElement(M,{title:a.name,description:a.episode}))))));return e.createElement("div",{className:"m-lg"},e.createElement(i,{gutter:[24,16]},e.createElement(s,{xs:24,md:6,lg:6},e.createElement("div",{className:"side-text"},"Episodes")),e.createElement(s,{xs:24,md:18,lg:18},e.createElement(i,{gutter:[24,16],className:"cards"},o))))};const{Meta:L}=n,z=a=>{const{id:t}=a.match.params,r=l`
		{
			episode(id: "${t}") {
				name
				air_date
...
`,D=a=>{const{loading:t,error:r,data:l}=c(C);if(t)return e.createElement("div",{className:"loader"},e.createElement("div",{className:"lds-ripple"},e.createElement("div",null),e.createElement("div",null)));if(r)return e.createElement("div",{className:"loader"},e.createElement("p",{className:"error"},"Error happen. Try Again."));const{results:d}=l.locations,o=d.map(((a,t)=>e.createElement(s,{xs:24,sm:8,lg:6,key:t},e.createElement(m,{to:`/locations/${a.id}`},e.createElement(n,{hoverable:!0},e.createElement(S,{title:a.name,description:a.type}))))));return e.createElement("div",{className:"m-lg"},e.createElement(i,{gutter:[24,16]},e.createElement(s,{xs:24,md:6,lg:6},e.createElement("div",{className:"side-text"},"Locations")),e.createElement(s,{xs:24,md:18,lg:18},e.createElement(i,{gutter:[24,16],className:"cards"},o))))},{Meta:H}=n,_=a=>{const{id:t}=a.match.params,r=l`
		{
			location(id: "${t}") {
				name
				type
